...
def changeofowner(request):
    if request.method=='POST':
        ...
        # template = render_to_string('users/email_message.html',{'name':request.changeofownerdetail.new_fullname})

        # email = EmailMessage(
        #     'Application Successfull',
        #     template,
        #     settings.EMAIL_HOST_USER,
                        #     [request.changeofownerdetail.new_email],
                        #     fail_silently=False,
                        # )
